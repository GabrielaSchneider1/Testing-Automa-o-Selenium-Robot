...
CAMPO_NOME = driver.find_element_by_css_selector('#first-name').send_keys('Gabriela')
CAMPO_SOBRENOME = driver.find_element_by_css_selector('#last-name').send_keys('Prates')
